	...
	if($theme_skin != 'ascend') { ?>
		<div class="container">
			<!--<div id="single-below-header" class="<?php // echo $fullscreen_class; ?> custom-skip">
				...
				<?php // echo '<a href=""><span class="share-count-total">0</span> <span class="plural">'. __('Shares',NECTAR_THEME_NAME) . '</span> <span class="singular">'. __('Share',NECTAR_THEME_NAME) .'</span></a>'; nectar_blog_social_sharing(); ?> </span>
							...
							<div id="single-meta" data-sharing="<?php echo ( !empty($options['blog_social']) && $options['blog_social'] == 1 ) ? '1' : '0'; ?>">
								<ul>
									...
									<li class="meta-comment-count">
										<a href="<?php // comments_link(); ?>"><i class="icon-default-style steadysets-icon-chat"></i> 
