<?php
/**
 * Functions grabbed from the Automattic _s theme.
 * https://github.com/Automattic/_s/blob/master/inc/template-tags.php
 *
 * @package _s
 */
    ...
    edit_post_link(
      sprintf(
        wp_kses(
          ...
          __( '<span class="glyphicon glyphicon-pencil"></span> Edit <span class="screen-reader-text">%s</span>', '_s' ),
          array(
            'span' => array(
              'class' => array(),
            ),
