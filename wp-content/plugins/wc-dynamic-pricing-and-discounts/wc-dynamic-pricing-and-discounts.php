...
define('RP_WCDPD_VERSION', '1.0.13');
...
if (!class_exists('RP_WCDPD')) {
    ...
    class RP_WCDPD
    {
        ...
        public function apply_discounts()
        {
            ...
            // Remove cart discounts (if previously applied but no longer valid)
                ...
                if (!$coupon->id && $woocommerce->cart->has_discount($this->opt['settings']['cart_discount_title'])) {
                    ...
                    $woocommerce->cart->remove_coupon($this->opt['settings']['cart_discount_title']);
            ...
            if (current_filter() == 'woocommerce_ajax_added_to_cart') {
        ...
        public function apply_fake_coupon()
        {
            ...
            if ($the_coupon->id && $the_coupon->is_valid() && !$woocommerce->cart->has_discount($this->opt['settings']['cart_discount_title'])) {
