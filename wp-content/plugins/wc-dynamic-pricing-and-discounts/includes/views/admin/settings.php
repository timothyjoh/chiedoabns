        ...
        <div class="rp_wcdpd_left">
            <form method="post" action="options.php" enctype="multipart/form-data">
                ...
                <table class="form-table"><tbody>
                    ...
                    <tr valign="top">
                        <th scope="row"><?php _e('Cart discounts applied', 'rp_wcdpd'); ?></th>
                        <td>
                            <select id="rp_wcdpd_settings_apply_cart_discounts" name="rp_wcdpd_options[settings][apply_cart_discounts]" class="rp_wcdpd_field rp_wcdpd_settings_apply_cart_discounts_field">
                                <option value="excl_tax" <?php echo ($this->opt['settings']['apply_cart_discounts'] == 'excl_tax' ? 'selected="selected"' : ''); ?>><?php _e('Before tax (exclusive)', 'rp_wcdpd'); ?></option>
                                <option value="incl_tax" <?php echo ($this->opt['settings']['apply_cart_discounts'] == 'incl_tax' ? 'selected="selected"' : ''); ?>><?php _e('After tax (inclusive)', 'rp_wcdpd'); ?></option>
                            </select>
                        </td>
                    </tr>
