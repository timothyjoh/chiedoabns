...
if (!class_exists('VC_Extensions_AvatarWithPopup')) {
    class VC_Extensions_AvatarWithPopup{
        function VC_Extensions_AvatarWithPopup() {
          if(version_compare(WPB_VC_VERSION,  "4.4")>= 0){
            ...
            "params" => array(
              ...
              array(
                ...
                "group" => "Avatar",
                "description" => __("Default we will use the original image, specify a width. For example, 200 will resize the image to width 200. Please use it carefully, may not work with some server setup.", "vc_avatarwithpopup_cq")
              ),
              array(
                'type' => 'dropdown',
            ...
            "params" => array(
              ...
              array(
                ...
                "dependency" => Array('element' => "resizeavatarimage", 'value' => array('yes')),
                "group" => "Avatar",
                "description" => __("Default we will use the original image, specify a width here. For example, 200 will resize the image to width 200. Please use it carefully, may not work with some server setup.", "vc_avatarwithpopup_cq")
              ),
              array(
                "type" => "textfield",
                "heading" => __("Optional title under the avatar", "vc_avatarwithpopup_cq"),
        ...
        add_shortcode('cq_vc_avatarwithpopup', 'cq_vc_avatarwithpopup_func');
