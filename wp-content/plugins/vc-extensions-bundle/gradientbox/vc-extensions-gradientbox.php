...
if (!class_exists('VC_Extensions_GradientBox')) {
    class VC_Extensions_GradientBox{
        function VC_Extensions_GradientBox() {
        ...
        add_shortcode('cq_vc_gradientbox', 'cq_vc_gradientbox_func');
