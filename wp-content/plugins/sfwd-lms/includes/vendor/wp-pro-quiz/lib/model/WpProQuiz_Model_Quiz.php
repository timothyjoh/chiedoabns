...
class WpProQuiz_Model_Quiz extends WpProQuiz_Model_Model {
	...
	const QUIZ_MODUS_NORMAL_CHECK = 4; //check correct quiz mode by Bharat
	...
	public function getViewProfileStatistics() {
		...
		return apply_filters( 'leasndash_quiz_default_viewPofileStatistics', $this->_viewPofileStatistics );
	}
