										...
										<div id="prerequisiteBox" style="display: none;">
											<table>
												<tr>
													...
													<th style="padding: 0; width: 400px;"><?php echo sprintf( _x('Prerequisites (This %s have to be finished)', 'Prerequisites (This quiz have to be finished)', 'wp-pro-quiz'), LearnDash_Custom_Label::label_to_lower( 'quiz' ) ); ?></th>
												</tr>
												<tr>
													<td style="padding: 0;">
						...
						<thead>
							<tr>
								<th style="width: 25%;"><?php _e('Normal', 'wp-pro-quiz'); ?></th>
 								<th style="width: 25%;"><?php _e('Check -> Correct -> Next', 'wp-pro-quiz'); ?></th>
						...
						<tbody>
							<tr>
								<td><label><input type="radio" name="quizModus" value="0" <?php $this->checked($this->quiz->getQuizModus(), WpProQuiz_Model_Quiz::QUIZ_MODUS_NORMAL); ?>> <?php _e('Activate', 'wp-pro-quiz'); ?></label></td>
 								<td><label><input type="radio" name="quizModus" value="4" <?php $this->checked($this->quiz->getQuizModus(), WpProQuiz_Model_Quiz::QUIZ_MODUS_NORMAL_CHECK); ?>> <?php _e('Activate', 'wp-pro-quiz'); ?></label></td>
							...
							<tr>
								<td>
 								...
 								<td>
 									<?php _e('Each question can be checked for correctness, Does not support multiple choice questions.', 'wp-pro-quiz'); ?>
 								</td>
								<td>
