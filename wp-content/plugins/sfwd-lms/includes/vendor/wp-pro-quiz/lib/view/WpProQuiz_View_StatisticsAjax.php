...
class WpProQuiz_View_StatisticsAjax extends WpProQuiz_View_View {
			...
			<tbody>
				...
				<?php if(!$this->avg && $q['statistcAnswerData'] !== null) { ?>
					...
					<tr style="display: none;">
						<th colspan="9">
							<?php $this->showUserAnswer($q['questionAnswerData'], $q['statistcAnswerData'], $q['answerType'], $q['questionId'] ); ?>
	...
	private function showUserAnswer($qAnswerData, $sAnswerData, $anserType, $questionId ) {
		$matrix = array();
