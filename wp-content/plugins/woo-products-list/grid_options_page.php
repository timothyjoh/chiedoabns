    ...
    <div class="<?php if ($hidebar !=1) { echo 'leftpanel'; } ?>">    
      <form method="post" action="options.php">
            ...
            <div class="fieldwrap">
              ...
              <small>'. __('Please drag and drop the below list elements to order the columns of the table', 'wcplpro') .'</small>
              <ul id="colsort">
            ';
            foreach($orderfields as $field => $fieldtext) {
              echo '<li>&#8597; <input type="hidden" name="wcplpro_order['. $field .']" value="'. $fieldtext .'" />'. $fieldtext .'</li>';
            }
            echo '
              </ul>
            </div>';        
