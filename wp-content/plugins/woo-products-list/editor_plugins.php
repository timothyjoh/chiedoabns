...
function wcplpro_insert_dialog() {
  ...
  $out .= '</select>
    ...
    <tr>
      <td>
        <label id="wcplpro_categories_inc-l" class="mce-widget mce-label mce-first" for="wcplpro_tags_inc" aria-disabled="false">'. __('Include Tags', 'wcplpro') .'</label>
      </td>
      <td class="setting_value">
        <select id="wcplpro_tags_inc" name="wcplpro_tags_inc" class="wcprpro-enhanced-select enhanced" multiple  data-placeholder="'. __('Select or type to search', 'wcplpro') .'">
  ...
  $out .= '
    ...
    <tr>
      <td>
        <label id="wcplpro_tags_exc-l" class="mce-widget mce-label mce-first" for="wcplpro_tags_exc" aria-disabled="false">'. __('Exculde Tags', 'wcplpro') .'</label>
      </td>
      <td class="setting_value">
        <select id="wcplpro_tags_exc" name="wcplpro_tags_exc" class="wcprpro-enhanced-select enhanced" multiple  data-placeholder="'. __('Select or type to search', 'wcplpro') .'">
