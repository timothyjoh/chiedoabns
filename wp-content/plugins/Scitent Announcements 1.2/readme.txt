v1.1
Updated so that JS for hight to not block menus is baked in to main files.

v1.0
commandeered this plugin for Scitent use and customized… removed custom CSS, added function for front page only…but it must be commented out to in the php to show on all pages again

TODO: add checkbox to settings page for ‘font page only’ option.
