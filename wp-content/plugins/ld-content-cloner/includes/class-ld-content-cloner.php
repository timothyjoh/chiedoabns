...
class LdContentCloner
{
    ...
    private function loadDependencies()
    {
        ...
        require_once plugin_dir_path(dirname(__FILE__)) . 'includes/class-ldcc-course-enabled.php';
    ...
    private function defineAdminHooks()
    {
        ...
        $this->loader->addAction('wp_ajax_duplicate_course_enabled', $ld_course_enabled, 'createDuplicateCourse');
        $this->loader->addAction('wp_ajax_duplicate_lesson_enabled', $ld_course_enabled, 'createDuplicateLesson');
        $this->loader->addAction('wp_ajax_duplicate_quiz_enabled', $ld_course_enabled, 'duplicateQuiz');
